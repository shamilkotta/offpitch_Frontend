...
function CtaOrganize() {
  ...
  return (
    <div className="h-[75vh] max-h-[700px] mb-10 sm:max-h-[2000] bg-[#0D084D] text-white flex flex-col sm:flex-row justify-between mx-auto max-w-[1500px] py-6 px-5 sm:px-10 ">
