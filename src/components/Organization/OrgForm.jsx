...
function OrgForm({ onClose, data, profile, reRender }) {
  ...
  const handleSubmit = (values) => {
    ...
    return axios.put("/user/organization", { ...values, photoData: photoURL });
  };
  ...
  return (
    ...
    >
      <h1 className="text-lg font-medium mb-5">Create new Organization</h1>
